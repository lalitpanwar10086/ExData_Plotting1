...
plot(x = train$datetime, y = train$Voltage, xlab = "datetime", ylab = "Voltage", type='l')
...
plot(x = train$datetime, y = train$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type='l')
dev.off()
